...
var Render = {
  ...
  player: function(ctx, width, height, resolution, roadWidth, sprites, speedPercent, scale, destX, destY, steer, updown) {
    ...
    var bounce = (4 * Math.random() * speedPercent * resolution) * Util.randomChoice([-1,1]);
    // var bounce = 0;
    var sprite;
    if (steer < 0)
...
var SPRITES = {
  ...
  // PLAYER_LEFT:            { x:  995, y:    5, w:  200, h:  315 },
  // PLAYER_STRAIGHT:        { x:    5, y:    5, w:  215, h:  540  },
  // PLAYER_RIGHT:           {x:  929, y:  897, w:  235, h:  118 }

  // PLAYER_UPHILL_LEFT:     { x: 1383, y:  961, w:   80, h:   45 },
  // PLAYER_UPHILL_STRAIGHT: { x: 1295, y: 1018, w:   80, h:   45 },
  // PLAYER_UPHILL_RIGHT:    { x: 1385, y: 1018, w:   80, h:   45 },
  // PLAYER_LEFT:            { x: 1365, y:  644, w:  100, h:   78 },
  // PLAYER_STRAIGHT:        { x: 1365, y:  644, w:  100, h:   78 },
  // PLAYER_RIGHT:           { x: 1365, y:  644, w:  100, h:   78 }
  //
  PLAYER_UPHILL_LEFT:     { x: 1383, y:  961, w:   80, h:   45 },
  PLAYER_UPHILL_STRAIGHT: { x: 1295, y: 1018, w:   80, h:   45 },
  PLAYER_UPHILL_RIGHT:    { x: 1385, y: 1018, w:   80, h:   45 },
